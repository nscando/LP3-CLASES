<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Baja.aspx.cs" Inherits="LP3_CLASES.Clase3.Baja" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            <asp:Button ID="btnAceptar" runat="server" Text="Baja Alumno" OnClick="btnAceptar_Click" />
