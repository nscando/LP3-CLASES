<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modificacion.aspx.cs" Inherits="LP3_CLASES.Clase3.Modificacion" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            <asp:Button ID="btnBuscar" runat="server" Text="Buscar Alumno" OnClick="btnBuscar_Click"></asp:Button>
            <br />
            <br />
            ...
            <br />
            <br />
            <asp:Button ID="btnAceptar" runat="server" Text="Modificar Alumno" OnClick="btnAceptar_Click" />
